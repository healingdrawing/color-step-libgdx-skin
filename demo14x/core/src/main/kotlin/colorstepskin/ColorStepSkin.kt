...
class ColorStepSkin : Skin() {
    ...
    /*dark zero*/
    val scrollZeroDark:Array<ScrollPaneStyle> = Array(101){ ScrollPaneStyle() }
    val splitZeroDark:Array<SplitPaneStyle> = Array(101){ SplitPaneStyle() }
    val treeZeroDark:Array<TreeStyle> = Array(101){ TreeStyle() }
    val labelZeroDark:Array<LabelStyle> = Array(101){ LabelStyle() }
    val buttonZeroDark:Array<ButtonStyle> = Array(101){ ButtonStyle() }
    val tbuttonZeroDark:Array<TextButtonStyle> = Array(101){ TextButtonStyle() }
    val checkZeroDark:Array<CheckBoxStyle> = Array(101){ CheckBoxStyle() }
    val tfieldZeroDark:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val tareaZeroDark:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val listZeroDark:Array<ListStyle> = Array(101){ ListStyle() }
    val selectZeroDark:Array<SelectBoxStyle> = Array(101){ SelectBoxStyle() }
    val progressZeroDark:Array<ProgressBarStyle> = Array(101){ ProgressBarStyle() }
    val sliderZeroDark:Array<SliderStyle> = Array(101){ SliderStyle() }
    val windowZeroDark:Array<WindowStyle> = Array(101){ WindowStyle() }
    val tpadZeroDark:Array<TouchpadStyle> = Array(101){ TouchpadStyle() }
    val dialogZeroDark:Array<WindowStyle> = Array(101){ WindowStyle() }
    
    /*dark one*/
    val scrollOneDark:Array<ScrollPaneStyle> = Array(101){ ScrollPaneStyle() }
    val splitOneDark:Array<SplitPaneStyle> = Array(101){ SplitPaneStyle() }
    val treeOneDark:Array<TreeStyle> = Array(101){ TreeStyle() }
    val labelOneDark:Array<LabelStyle> = Array(101){ LabelStyle() }
    val buttonOneDark:Array<ButtonStyle> = Array(101){ ButtonStyle() }
    val tbuttonOneDark:Array<TextButtonStyle> = Array(101){ TextButtonStyle() }
    val checkOneDark:Array<CheckBoxStyle> = Array(101){ CheckBoxStyle() }
    val tfieldOneDark:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val tareaOneDark:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val listOneDark:Array<ListStyle> = Array(101){ ListStyle() }
    val selectOneDark:Array<SelectBoxStyle> = Array(101){ SelectBoxStyle() }
    val progressOneDark:Array<ProgressBarStyle> = Array(101){ ProgressBarStyle() }
    val sliderOneDark:Array<SliderStyle> = Array(101){ SliderStyle() }
    val windowOneDark:Array<WindowStyle> = Array(101){ WindowStyle() }
    val tpadOneDark:Array<TouchpadStyle> = Array(101){ TouchpadStyle() }
    val dialogOneDark:Array<WindowStyle> = Array(101){ WindowStyle() }
    ...
    /*acid zero*/
    val scrollZeroAcid:Array<ScrollPaneStyle> = Array(101){ ScrollPaneStyle() }
    val splitZeroAcid:Array<SplitPaneStyle> = Array(101){ SplitPaneStyle() }
    val treeZeroAcid:Array<TreeStyle> = Array(101){ TreeStyle() }
    val labelZeroAcid:Array<LabelStyle> = Array(101){ LabelStyle() }
    val buttonZeroAcid:Array<ButtonStyle> = Array(101){ ButtonStyle() }
    val tbuttonZeroAcid:Array<TextButtonStyle> = Array(101){ TextButtonStyle() }
    val checkZeroAcid:Array<CheckBoxStyle> = Array(101){ CheckBoxStyle() }
    val tfieldZeroAcid:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val tareaZeroAcid:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val listZeroAcid:Array<ListStyle> = Array(101){ ListStyle() }
    val selectZeroAcid:Array<SelectBoxStyle> = Array(101){ SelectBoxStyle() }
    val progressZeroAcid:Array<ProgressBarStyle> = Array(101){ ProgressBarStyle() }
    val sliderZeroAcid:Array<SliderStyle> = Array(101){ SliderStyle() }
    val windowZeroAcid:Array<WindowStyle> = Array(101){ WindowStyle() }
    val tpadZeroAcid:Array<TouchpadStyle> = Array(101){ TouchpadStyle() }
    val dialogZeroAcid:Array<WindowStyle> = Array(101){ WindowStyle() }
    
    /*acid one*/
    val scrollOneAcid:Array<ScrollPaneStyle> = Array(101){ ScrollPaneStyle() }
    val splitOneAcid:Array<SplitPaneStyle> = Array(101){ SplitPaneStyle() }
    val treeOneAcid:Array<TreeStyle> = Array(101){ TreeStyle() }
    val labelOneAcid:Array<LabelStyle> = Array(101){ LabelStyle() }
    val buttonOneAcid:Array<ButtonStyle> = Array(101){ ButtonStyle() }
    val tbuttonOneAcid:Array<TextButtonStyle> = Array(101){ TextButtonStyle() }
    val checkOneAcid:Array<CheckBoxStyle> = Array(101){ CheckBoxStyle() }
    val tfieldOneAcid:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val tareaOneAcid:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val listOneAcid:Array<ListStyle> = Array(101){ ListStyle() }
    val selectOneAcid:Array<SelectBoxStyle> = Array(101){ SelectBoxStyle() }
    val progressOneAcid:Array<ProgressBarStyle> = Array(101){ ProgressBarStyle() }
    val sliderOneAcid:Array<SliderStyle> = Array(101){ SliderStyle() }
    val windowOneAcid:Array<WindowStyle> = Array(101){ WindowStyle() }
    val tpadOneAcid:Array<TouchpadStyle> = Array(101){ TouchpadStyle() }
    val dialogOneAcid:Array<WindowStyle> = Array(101){ WindowStyle() }
    ...
    /*sun zero*/
    val scrollZeroSun:Array<ScrollPaneStyle> = Array(101){ ScrollPaneStyle() }
    val splitZeroSun:Array<SplitPaneStyle> = Array(101){ SplitPaneStyle() }
    val treeZeroSun:Array<TreeStyle> = Array(101){ TreeStyle() }
    val labelZeroSun:Array<LabelStyle> = Array(101){ LabelStyle() }
    val buttonZeroSun:Array<ButtonStyle> = Array(101){ ButtonStyle() }
    val tbuttonZeroSun:Array<TextButtonStyle> = Array(101){ TextButtonStyle() }
    val checkZeroSun:Array<CheckBoxStyle> = Array(101){ CheckBoxStyle() }
    val tfieldZeroSun:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val tareaZeroSun:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val listZeroSun:Array<ListStyle> = Array(101){ ListStyle() }
    val selectZeroSun:Array<SelectBoxStyle> = Array(101){ SelectBoxStyle() }
    val progressZeroSun:Array<ProgressBarStyle> = Array(101){ ProgressBarStyle() }
    val sliderZeroSun:Array<SliderStyle> = Array(101){ SliderStyle() }
    val windowZeroSun:Array<WindowStyle> = Array(101){ WindowStyle() }
    val tpadZeroSun:Array<TouchpadStyle> = Array(101){ TouchpadStyle() }
    val dialogZeroSun:Array<WindowStyle> = Array(101){ WindowStyle() }
    
    /*sun one*/
    val scrollOneSun:Array<ScrollPaneStyle> = Array(101){ ScrollPaneStyle() }
    val splitOneSun:Array<SplitPaneStyle> = Array(101){ SplitPaneStyle() }
    val treeOneSun:Array<TreeStyle> = Array(101){ TreeStyle() }
    val labelOneSun:Array<LabelStyle> = Array(101){ LabelStyle() }
    val buttonOneSun:Array<ButtonStyle> = Array(101){ ButtonStyle() }
    val tbuttonOneSun:Array<TextButtonStyle> = Array(101){ TextButtonStyle() }
    val checkOneSun:Array<CheckBoxStyle> = Array(101){ CheckBoxStyle() }
    val tfieldOneSun:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val tareaOneSun:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val listOneSun:Array<ListStyle> = Array(101){ ListStyle() }
    val selectOneSun:Array<SelectBoxStyle> = Array(101){ SelectBoxStyle() }
    val progressOneSun:Array<ProgressBarStyle> = Array(101){ ProgressBarStyle() }
    val sliderOneSun:Array<SliderStyle> = Array(101){ SliderStyle() }
    val windowOneSun:Array<WindowStyle> = Array(101){ WindowStyle() }
    val tpadOneSun:Array<TouchpadStyle> = Array(101){ TouchpadStyle() }
    val dialogOneSun:Array<WindowStyle> = Array(101){ WindowStyle() }
    ...
    /*gum zero*/
    val scrollZeroGum:Array<ScrollPaneStyle> = Array(101){ ScrollPaneStyle() }
    val splitZeroGum:Array<SplitPaneStyle> = Array(101){ SplitPaneStyle() }
    val treeZeroGum:Array<TreeStyle> = Array(101){ TreeStyle() }
    val labelZeroGum:Array<LabelStyle> = Array(101){ LabelStyle() }
    val buttonZeroGum:Array<ButtonStyle> = Array(101){ ButtonStyle() }
    val tbuttonZeroGum:Array<TextButtonStyle> = Array(101){ TextButtonStyle() }
    val checkZeroGum:Array<CheckBoxStyle> = Array(101){ CheckBoxStyle() }
    val tfieldZeroGum:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val tareaZeroGum:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val listZeroGum:Array<ListStyle> = Array(101){ ListStyle() }
    val selectZeroGum:Array<SelectBoxStyle> = Array(101){ SelectBoxStyle() }
    val progressZeroGum:Array<ProgressBarStyle> = Array(101){ ProgressBarStyle() }
    val sliderZeroGum:Array<SliderStyle> = Array(101){ SliderStyle() }
    val windowZeroGum:Array<WindowStyle> = Array(101){ WindowStyle() }
    val tpadZeroGum:Array<TouchpadStyle> = Array(101){ TouchpadStyle() }
    val dialogZeroGum:Array<WindowStyle> = Array(101){ WindowStyle() }
    
    /*gum one*/
    val scrollOneGum:Array<ScrollPaneStyle> = Array(101){ ScrollPaneStyle() }
    val splitOneGum:Array<SplitPaneStyle> = Array(101){ SplitPaneStyle() }
    val treeOneGum:Array<TreeStyle> = Array(101){ TreeStyle() }
    val labelOneGum:Array<LabelStyle> = Array(101){ LabelStyle() }
    val buttonOneGum:Array<ButtonStyle> = Array(101){ ButtonStyle() }
    val tbuttonOneGum:Array<TextButtonStyle> = Array(101){ TextButtonStyle() }
    val checkOneGum:Array<CheckBoxStyle> = Array(101){ CheckBoxStyle() }
    val tfieldOneGum:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val tareaOneGum:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val listOneGum:Array<ListStyle> = Array(101){ ListStyle() }
    val selectOneGum:Array<SelectBoxStyle> = Array(101){ SelectBoxStyle() }
    val progressOneGum:Array<ProgressBarStyle> = Array(101){ ProgressBarStyle() }
    val sliderOneGum:Array<SliderStyle> = Array(101){ SliderStyle() }
    val windowOneGum:Array<WindowStyle> = Array(101){ WindowStyle() }
    val tpadOneGum:Array<TouchpadStyle> = Array(101){ TouchpadStyle() }
    val dialogOneGum:Array<WindowStyle> = Array(101){ WindowStyle() }
    ...
    /*snow zero*/
    val scrollZeroSnow:Array<ScrollPaneStyle> = Array(101){ ScrollPaneStyle() }
    val splitZeroSnow:Array<SplitPaneStyle> = Array(101){ SplitPaneStyle() }
    val treeZeroSnow:Array<TreeStyle> = Array(101){ TreeStyle() }
    val labelZeroSnow:Array<LabelStyle> = Array(101){ LabelStyle() }
    val buttonZeroSnow:Array<ButtonStyle> = Array(101){ ButtonStyle() }
    val tbuttonZeroSnow:Array<TextButtonStyle> = Array(101){ TextButtonStyle() }
    val checkZeroSnow:Array<CheckBoxStyle> = Array(101){ CheckBoxStyle() }
    val tfieldZeroSnow:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val tareaZeroSnow:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val listZeroSnow:Array<ListStyle> = Array(101){ ListStyle() }
    val selectZeroSnow:Array<SelectBoxStyle> = Array(101){ SelectBoxStyle() }
    val progressZeroSnow:Array<ProgressBarStyle> = Array(101){ ProgressBarStyle() }
    val sliderZeroSnow:Array<SliderStyle> = Array(101){ SliderStyle() }
    val windowZeroSnow:Array<WindowStyle> = Array(101){ WindowStyle() }
    val tpadZeroSnow:Array<TouchpadStyle> = Array(101){ TouchpadStyle() }
    val dialogZeroSnow:Array<WindowStyle> = Array(101){ WindowStyle() }
    
    /*snow one*/
    val scrollOneSnow:Array<ScrollPaneStyle> = Array(101){ ScrollPaneStyle() }
    val splitOneSnow:Array<SplitPaneStyle> = Array(101){ SplitPaneStyle() }
    val treeOneSnow:Array<TreeStyle> = Array(101){ TreeStyle() }
    val labelOneSnow:Array<LabelStyle> = Array(101){ LabelStyle() }
    val buttonOneSnow:Array<ButtonStyle> = Array(101){ ButtonStyle() }
    val tbuttonOneSnow:Array<TextButtonStyle> = Array(101){ TextButtonStyle() }
    val checkOneSnow:Array<CheckBoxStyle> = Array(101){ CheckBoxStyle() }
    val tfieldOneSnow:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val tareaOneSnow:Array<TextFieldStyle> = Array(101){ TextFieldStyle() }
    val listOneSnow:Array<ListStyle> = Array(101){ ListStyle() }
    val selectOneSnow:Array<SelectBoxStyle> = Array(101){ SelectBoxStyle() }
    val progressOneSnow:Array<ProgressBarStyle> = Array(101){ ProgressBarStyle() }
    val sliderOneSnow:Array<SliderStyle> = Array(101){ SliderStyle() }
    val windowOneSnow:Array<WindowStyle> = Array(101){ WindowStyle() }
    val tpadOneSnow:Array<TouchpadStyle> = Array(101){ TouchpadStyle() }
    val dialogOneSnow:Array<WindowStyle> = Array(101){ WindowStyle() }
    ...
    fun prepare(){
        ...
        /*default*/
        defaultZeroDark() /*short name binded to text sun scheme. Call other (declaired bottom) from this place , to make them default*/
        for (hue in 0..100){
    ...
    fun defaultZeroDark(){
        for (hue in 0..100){
            scroll[hue] = scrollZeroDark[hue]
            split[hue] = splitZeroDark[hue]
            tree[hue] = treeZeroDark[hue]
            label[hue] = labelZeroDark[hue]
            button[hue] = buttonZeroDark[hue]
            tbutton[hue] = tbuttonZeroDark[hue]
            check[hue] = checkZeroDark[hue]
            tfield[hue] = tfieldZeroDark[hue]
            tarea[hue] = tareaZeroDark[hue]
            list[hue] = listZeroDark[hue]
            select[hue] = selectZeroDark[hue]
            progress[hue] = progressZeroDark[hue]
            slider[hue] = sliderZeroDark[hue]
            window[hue] = windowZeroDark[hue]
            tpad[hue] = tpadZeroDark[hue]
            dialog[hue] = dialogZeroDark[hue]
        }
    }
    
    fun defaultOneDark(){
        for (hue in 0..100){
            scroll[hue] = scrollOneDark[hue]
            split[hue] = splitOneDark[hue]
            tree[hue] = treeOneDark[hue]
            label[hue] = labelOneDark[hue]
            button[hue] = buttonOneDark[hue]
            tbutton[hue] = tbuttonOneDark[hue]
            check[hue] = checkOneDark[hue]
            tfield[hue] = tfieldOneDark[hue]
            tarea[hue] = tareaOneDark[hue]
            list[hue] = listOneDark[hue]
            select[hue] = selectOneDark[hue]
            progress[hue] = progressOneDark[hue]
            slider[hue] = sliderOneDark[hue]
            window[hue] = windowOneDark[hue]
            tpad[hue] = tpadOneDark[hue]
            dialog[hue] = dialogOneDark[hue]
        }
    }
    ...
    fun defaultZeroAcid(){
        for (hue in 0..100){
            scroll[hue] = scrollZeroAcid[hue]
            split[hue] = splitZeroAcid[hue]
            tree[hue] = treeZeroAcid[hue]
            label[hue] = labelZeroAcid[hue]
            button[hue] = buttonZeroAcid[hue]
            tbutton[hue] = tbuttonZeroAcid[hue]
            check[hue] = checkZeroAcid[hue]
            tfield[hue] = tfieldZeroAcid[hue]
            tarea[hue] = tareaZeroAcid[hue]
            list[hue] = listZeroAcid[hue]
            select[hue] = selectZeroAcid[hue]
            progress[hue] = progressZeroAcid[hue]
            slider[hue] = sliderZeroAcid[hue]
            window[hue] = windowZeroAcid[hue]
            tpad[hue] = tpadZeroAcid[hue]
            dialog[hue] = dialogZeroAcid[hue]
        }
    }
    
    fun defaultOneAcid(){
        for (hue in 0..100){
            scroll[hue] = scrollOneAcid[hue]
            split[hue] = splitOneAcid[hue]
            tree[hue] = treeOneAcid[hue]
            label[hue] = labelOneAcid[hue]
            button[hue] = buttonOneAcid[hue]
            tbutton[hue] = tbuttonOneAcid[hue]
            check[hue] = checkOneAcid[hue]
            tfield[hue] = tfieldOneAcid[hue]
            tarea[hue] = tareaOneAcid[hue]
            list[hue] = listOneAcid[hue]
            select[hue] = selectOneAcid[hue]
            progress[hue] = progressOneAcid[hue]
            slider[hue] = sliderOneAcid[hue]
            window[hue] = windowOneAcid[hue]
            tpad[hue] = tpadOneAcid[hue]
            dialog[hue] = dialogOneAcid[hue]
        }
    }
    ...
    fun defaultZeroSun(){
        for (hue in 0..100){
            scroll[hue] = scrollZeroSun[hue]
            split[hue] = splitZeroSun[hue]
            tree[hue] = treeZeroSun[hue]
            label[hue] = labelZeroSun[hue]
            button[hue] = buttonZeroSun[hue]
            tbutton[hue] = tbuttonZeroSun[hue]
            check[hue] = checkZeroSun[hue]
            tfield[hue] = tfieldZeroSun[hue]
            tarea[hue] = tareaZeroSun[hue]
            list[hue] = listZeroSun[hue]
            select[hue] = selectZeroSun[hue]
            progress[hue] = progressZeroSun[hue]
            slider[hue] = sliderZeroSun[hue]
            window[hue] = windowZeroSun[hue]
            tpad[hue] = tpadZeroSun[hue]
            dialog[hue] = dialogZeroSun[hue]
        }
    }
    
    fun defaultOneSun(){
        for (hue in 0..100){
            scroll[hue] = scrollOneSun[hue]
            split[hue] = splitOneSun[hue]
            tree[hue] = treeOneSun[hue]
            label[hue] = labelOneSun[hue]
            button[hue] = buttonOneSun[hue]
            tbutton[hue] = tbuttonOneSun[hue]
            check[hue] = checkOneSun[hue]
            tfield[hue] = tfieldOneSun[hue]
            tarea[hue] = tareaOneSun[hue]
            list[hue] = listOneSun[hue]
            select[hue] = selectOneSun[hue]
            progress[hue] = progressOneSun[hue]
            slider[hue] = sliderOneSun[hue]
            window[hue] = windowOneSun[hue]
            tpad[hue] = tpadOneSun[hue]
            dialog[hue] = dialogOneSun[hue]
        }
    }
    ...
    fun defaultZeroGum(){
        for (hue in 0..100){
            scroll[hue] = scrollZeroGum[hue]
            split[hue] = splitZeroGum[hue]
            tree[hue] = treeZeroGum[hue]
            label[hue] = labelZeroGum[hue]
            button[hue] = buttonZeroGum[hue]
            tbutton[hue] = tbuttonZeroGum[hue]
            check[hue] = checkZeroGum[hue]
            tfield[hue] = tfieldZeroGum[hue]
            tarea[hue] = tareaZeroGum[hue]
            list[hue] = listZeroGum[hue]
            select[hue] = selectZeroGum[hue]
            progress[hue] = progressZeroGum[hue]
            slider[hue] = sliderZeroGum[hue]
            window[hue] = windowZeroGum[hue]
            tpad[hue] = tpadZeroGum[hue]
            dialog[hue] = dialogZeroGum[hue]
        }
    }
    
    fun defaultOneGum(){
        for (hue in 0..100){
            scroll[hue] = scrollOneGum[hue]
            split[hue] = splitOneGum[hue]
            tree[hue] = treeOneGum[hue]
            label[hue] = labelOneGum[hue]
            button[hue] = buttonOneGum[hue]
            tbutton[hue] = tbuttonOneGum[hue]
            check[hue] = checkOneGum[hue]
            tfield[hue] = tfieldOneGum[hue]
            tarea[hue] = tareaOneGum[hue]
            list[hue] = listOneGum[hue]
            select[hue] = selectOneGum[hue]
            progress[hue] = progressOneGum[hue]
            slider[hue] = sliderOneGum[hue]
            window[hue] = windowOneGum[hue]
            tpad[hue] = tpadOneGum[hue]
            dialog[hue] = dialogOneGum[hue]
        }
    }
    ...
    fun defaultZeroSnow(){
        for (hue in 0..100){
            scroll[hue] = scrollZeroSnow[hue]
            split[hue] = splitZeroSnow[hue]
            tree[hue] = treeZeroSnow[hue]
            label[hue] = labelZeroSnow[hue]
            button[hue] = buttonZeroSnow[hue]
            tbutton[hue] = tbuttonZeroSnow[hue]
            check[hue] = checkZeroSnow[hue]
            tfield[hue] = tfieldZeroSnow[hue]
            tarea[hue] = tareaZeroSnow[hue]
            list[hue] = listZeroSnow[hue]
            select[hue] = selectZeroSnow[hue]
            progress[hue] = progressZeroSnow[hue]
            slider[hue] = sliderZeroSnow[hue]
            window[hue] = windowZeroSnow[hue]
            tpad[hue] = tpadZeroSnow[hue]
            dialog[hue] = dialogZeroSnow[hue]
        }
    }
    
    fun defaultOneSnow(){
        for (hue in 0..100){
            scroll[hue] = scrollOneSnow[hue]
            split[hue] = splitOneSnow[hue]
            tree[hue] = treeOneSnow[hue]
            label[hue] = labelOneSnow[hue]
            button[hue] = buttonOneSnow[hue]
            tbutton[hue] = tbuttonOneSnow[hue]
            check[hue] = checkOneSnow[hue]
            tfield[hue] = tfieldOneSnow[hue]
            tarea[hue] = tareaOneSnow[hue]
            list[hue] = listOneSnow[hue]
            select[hue] = selectOneSnow[hue]
            progress[hue] = progressOneSnow[hue]
            slider[hue] = sliderOneSnow[hue]
            window[hue] = windowOneSnow[hue]
            tpad[hue] = tpadOneSnow[hue]
            dialog[hue] = dialogOneSnow[hue]
        }
    }
