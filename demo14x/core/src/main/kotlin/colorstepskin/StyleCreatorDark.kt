...
//            val hueD = cbox.dark.colorPair(hue, true)[0]//dark hue based
            ...
            scrollZeroDark[hue].vScrollKnob = newDrawable(getDrawable("inverted-vscrollknob"), opoD)
            scrollZeroDark[hue].vScroll = newDrawable(getDrawable("inverted-vscroll"), opoD)
            scrollZeroDark[hue].hScrollKnob = newDrawable(getDrawable("inverted-hscrollknob"), opoD)
            scrollZeroDark[hue].hScroll = newDrawable(getDrawable("inverted-hscroll"), opoD)
        
            splitZeroDark[hue].handle = newDrawable(getDrawable("inverted-splitpane"), hueL)
        
            treeZeroDark[hue].minus = newDrawable(getDrawable("tree-minus"), opoD)
            treeZeroDark[hue].plus = newDrawable(getDrawable("tree-plus"), opoD)
            treeZeroDark[hue].background = newDrawable(getDrawable("zero-tree-background"), hueL)
            treeZeroDark[hue].selection = newDrawable(getDrawable("tree-selection"), hueL)
        
            labelZeroDark[hue].background = newDrawable(getDrawable("zero-label-background"), hueL)
            labelZeroDark[hue].font = defaultFontFon
            labelZeroDark[hue].fontColor = opoD
        
            buttonZeroDark[hue].up = newDrawable(getDrawable("zero-button-up"), hueL)
            buttonZeroDark[hue].down = newDrawable(getDrawable("inverted-button-down"), hueL)
            buttonZeroDark[hue].checked = newDrawable(getDrawable("inverted-button-checked"), hueL)
            buttonZeroDark[hue].disabled = newDrawable(getDrawable("zero-button-disabled"), hueL)
        
            tbuttonZeroDark[hue].up = newDrawable(getDrawable("zero-button-up"), hueL)
            tbuttonZeroDark[hue].down = newDrawable(getDrawable("inverted-button-down"), hueL)
            tbuttonZeroDark[hue].checked = newDrawable(getDrawable("inverted-button-checked"), hueL)
            tbuttonZeroDark[hue].disabled = newDrawable(getDrawable("zero-button-disabled"), hueL)
            tbuttonZeroDark[hue].font = defaultFontFon
            tbuttonZeroDark[hue].fontColor = opoD
            tbuttonZeroDark[hue].disabledFontColor = hueL
        
            checkZeroDark[hue].checkboxOn = newDrawable(getDrawable("inverted-check-on"), opoD)
            checkZeroDark[hue].checkboxOff = newDrawable(getDrawable("inverted-check-off"), opoD)
            checkZeroDark[hue].checkboxOffDisabled = newDrawable(getDrawable("inverted-check-off"), hueL)
            checkZeroDark[hue].checkboxOnDisabled = newDrawable(getDrawable("inverted-check-on"), hueL)
            checkZeroDark[hue].font = defaultFontFon
            checkZeroDark[hue].fontColor = opoD
            checkZeroDark[hue].disabledFontColor = hueL
        
            tfieldZeroDark[hue].cursor = newDrawable(getDrawable("inverted-textfield-cursor"), opoD)
            tfieldZeroDark[hue].selection = newDrawable(getDrawable("inverted-textfield-selection"), opoL)
            tfieldZeroDark[hue].background = newDrawable(getDrawable("zero-textfield-background"), hueL)
            tfieldZeroDark[hue].disabledBackground = newDrawable(getDrawable("zero-textfield-disabled"), hueL)
            tfieldZeroDark[hue].focusedBackground = newDrawable(getDrawable("inverted-textfield-focused"), hueL)
            tfieldZeroDark[hue].font = defaultFontFon
            tfieldZeroDark[hue].fontColor = opoD
            tfieldZeroDark[hue].disabledFontColor = hueL
            /*because style class is same and inside Skin.add() next just override previous. And there is some shit inside,
            * because if no bottom syntax for textarea style , in time of creation textfield app crushed, looks like textfield use
            * textarea style but this style class named as TextFieldStyle etc , not sure. muddy place , but work finally*/
            tareaZeroDark[hue] = tfieldZeroDark[hue]
        
            listZeroDark[hue].background = newDrawable(getDrawable("zero-list-background"), hueL)
            listZeroDark[hue].selection = newDrawable(getDrawable("inverted-list-selection"), hueL)
            listZeroDark[hue].down = newDrawable(getDrawable("inverted-list-down"), hueL)
            listZeroDark[hue].font = defaultFontFon
            listZeroDark[hue].fontColorSelected = opoD
            listZeroDark[hue].fontColorUnselected = opoD
        
            selectZeroDark[hue].listStyle = listZeroDark[hue]
            selectZeroDark[hue].scrollStyle = scrollZeroDark[hue]
            selectZeroDark[hue].background = newDrawable(getDrawable("zero-select-background"), hueL)
            selectZeroDark[hue].backgroundDisabled = newDrawable(getDrawable("zero-select-disabled"), hueL)
            selectZeroDark[hue].font = defaultFontFon
            selectZeroDark[hue].fontColor = opoD
            selectZeroDark[hue].disabledFontColor = hueL
        
            progressZeroDark[hue].background = newDrawable(getDrawable("zero-progress-background"), hueL)
            progressZeroDark[hue].disabledBackground = newDrawable(getDrawable("zero-progress-disabledbackground"), hueL)
            progressZeroDark[hue].knobBefore = newDrawable(getDrawable("inverted-progress-knobbefore"), opoD)
            progressZeroDark[hue].disabledKnobBefore = newDrawable(getDrawable("inverted-progress-disabledknobbefore"), hueL)
        
            sliderZeroDark[hue].knob = newDrawable(getDrawable("inverted-slider-knob"), opoD)
            sliderZeroDark[hue].disabledKnob = newDrawable(getDrawable("inverted-slider-disabledknob"), hueL)
            sliderZeroDark[hue].background = newDrawable(getDrawable("zero-progress-background"), hueL)
            sliderZeroDark[hue].disabledBackground = newDrawable(getDrawable("zero-progress-disabledbackground"), hueL)
        
            windowZeroDark[hue].background = newDrawable(getDrawable("inverted-window-background"), hueL)
            windowZeroDark[hue].stageBackground = newDrawable(getDrawable("inverted-window-stagebackground"), hueL)
            windowZeroDark[hue].titleFont = defaultFontFon
            windowZeroDark[hue].titleFontColor = opoD
            /*same shit as for textfield, window widget use dialog widget style which class name is WindowStyle*/
            dialogZeroDark[hue] = windowZeroDark[hue]
        
            tpadZeroDark[hue].background = newDrawable(getDrawable("inverted-touchpad-background"), opoD)
            tpadZeroDark[hue].knob = newDrawable(getDrawable("inverted-touchpad-knob"), hueL)
        
            add("zero${hue}dark", scrollZeroDark[hue])
            add("zero${hue}dark", splitZeroDark[hue])
            add("zero${hue}dark", treeZeroDark[hue])
            add("zero${hue}dark", labelZeroDark[hue])
            add("zero${hue}dark", buttonZeroDark[hue])
            add("zero${hue}dark", tbuttonZeroDark[hue])
            add("zero${hue}dark", checkZeroDark[hue])
            add("zero${hue}dark", tfieldZeroDark[hue])
            add("zero${hue}dark", tareaZeroDark[hue])
            add("zero${hue}dark", listZeroDark[hue])
            add("zero${hue}dark", selectZeroDark[hue])
            add("zero${hue}dark", progressZeroDark[hue])
            add("zero${hue}dark", sliderZeroDark[hue])
            add("zero${hue}dark", windowZeroDark[hue])
            add("zero${hue}dark", tpadZeroDark[hue])
            add("zero${hue}dark", dialogZeroDark[hue])
...
//            val opoD = cbox.dark.colorPair(hue, true)[1]//dark oposite
            ...
            scrollOneDark[hue].vScrollKnob = newDrawable(getDrawable("vscrollknob"), opoL)
            scrollOneDark[hue].vScroll = newDrawable(getDrawable("vscroll"), opoL)
            scrollOneDark[hue].hScrollKnob = newDrawable(getDrawable("hscrollknob"), opoL)
            scrollOneDark[hue].hScroll = newDrawable(getDrawable("hscroll"), opoL)
        
            splitOneDark[hue].handle = newDrawable(getDrawable("splitpane"), opoL)
        
            treeOneDark[hue].minus = newDrawable(getDrawable("tree-minus"), hueL)
            treeOneDark[hue].plus = newDrawable(getDrawable("tree-plus"), hueL)
            treeOneDark[hue].background = newDrawable(getDrawable("zero-tree-background"), opoL)
            treeOneDark[hue].selection = newDrawable(getDrawable("tree-selection"), opoL)
        
            labelOneDark[hue].background = newDrawable(getDrawable("zero-label-background"), opoL)
            labelOneDark[hue].font = defaultFont
            labelOneDark[hue].fontColor = hueL
        
            buttonOneDark[hue].up = newDrawable(getDrawable("zero-button-up"), opoL)
            buttonOneDark[hue].down = newDrawable(getDrawable("button-down"), opoL)
            buttonOneDark[hue].checked = newDrawable(getDrawable("button-checked"), opoL)
            buttonOneDark[hue].disabled = newDrawable(getDrawable("zero-button-disabled"), opoL)
        
            tbuttonOneDark[hue].up = newDrawable(getDrawable("zero-button-up"), opoL)
            tbuttonOneDark[hue].down = newDrawable(getDrawable("button-down"), opoL)
            tbuttonOneDark[hue].checked = newDrawable(getDrawable("button-checked"), opoL)
            tbuttonOneDark[hue].disabled = newDrawable(getDrawable("zero-button-disabled"), opoL)
            tbuttonOneDark[hue].font = defaultFont
            tbuttonOneDark[hue].fontColor = hueL
            tbuttonOneDark[hue].disabledFontColor = opoL
        
            checkOneDark[hue].checkboxOn = newDrawable(getDrawable("check-on"), hueL)
            checkOneDark[hue].checkboxOff = newDrawable(getDrawable("check-off"), hueL)
            checkOneDark[hue].checkboxOffDisabled = newDrawable(getDrawable("check-off"), opoL)
            checkOneDark[hue].checkboxOnDisabled = newDrawable(getDrawable("check-on"), opoL)
            checkOneDark[hue].font = defaultFont
            checkOneDark[hue].fontColor = hueL
            checkOneDark[hue].disabledFontColor = opoL
        
            tfieldOneDark[hue].cursor = newDrawable(getDrawable("textfield-cursor"), opoL)
            tfieldOneDark[hue].selection = newDrawable(getDrawable("textfield-selection"), opoL)
            tfieldOneDark[hue].background = newDrawable(getDrawable("zero-textfield-background"), opoL)
            tfieldOneDark[hue].disabledBackground = newDrawable(getDrawable("zero-textfield-disabled"), opoL)
            tfieldOneDark[hue].focusedBackground = newDrawable(getDrawable("textfield-focused"), opoL)
            tfieldOneDark[hue].font = defaultFont
            tfieldOneDark[hue].fontColor = hueL
            tfieldOneDark[hue].disabledFontColor = opoL
        
            tareaOneDark[hue] = tfieldOneDark[hue]
        
            listOneDark[hue].background = newDrawable(getDrawable("zero-list-background"), opoL)
            listOneDark[hue].selection = newDrawable(getDrawable("list-selection"), opoL)
            listOneDark[hue].down = newDrawable(getDrawable("list-down"), opoL)
            listOneDark[hue].font = defaultFont
            listOneDark[hue].fontColorSelected = hueL
            listOneDark[hue].fontColorUnselected = hueL
        
            /*separated style for list inside select with scroll, to polish*/
            val sls = ListStyle()
            sls.background = newDrawable(getDrawable("zero-select-list-background"), opoL)
            sls.selection = newDrawable(getDrawable("list-selection"), opoL)
            sls.down = newDrawable(getDrawable("list-down"), opoL)
            sls.font = defaultFont
            sls.fontColorSelected = hueL
            ...
            selectOneDark[hue].listStyle = sls
            selectOneDark[hue].scrollStyle = scrollOneDark[hue]
            selectOneDark[hue].background = newDrawable(getDrawable("zero-select-background"), opoL)
            selectOneDark[hue].backgroundDisabled = newDrawable(getDrawable("zero-select-disabled"), opoL)
            selectOneDark[hue].font = defaultFont
            selectOneDark[hue].fontColor = hueL
            selectOneDark[hue].disabledFontColor = opoL
        
            progressOneDark[hue].background = newDrawable(getDrawable("zero-progress-background"), opoL)
            progressOneDark[hue].disabledBackground = newDrawable(getDrawable("zero-progress-disabledbackground"), opoL)
            progressOneDark[hue].knobBefore = newDrawable(getDrawable("progress-knobbefore"), hueL)
            progressOneDark[hue].disabledKnobBefore = newDrawable(getDrawable("progress-disabledknobbefore"), opoL)
        
            sliderOneDark[hue].knob = newDrawable(getDrawable("slider-knob"), hueL)
            sliderOneDark[hue].disabledKnob = newDrawable(getDrawable("slider-disabledknob"), opoL)
            sliderOneDark[hue].background = newDrawable(getDrawable("zero-progress-background"), opoL)
            sliderOneDark[hue].disabledBackground = newDrawable(getDrawable("zero-progress-disabledbackground"), opoL)
        
            windowOneDark[hue].background = newDrawable(getDrawable("window-background"), opoL)
            windowOneDark[hue].stageBackground = newDrawable(getDrawable("window-stagebackground"), opoL)
            windowOneDark[hue].titleFont = defaultFont
            windowOneDark[hue].titleFontColor = hueL
        
            dialogOneDark[hue] = windowOneDark[hue]
        
            tpadOneDark[hue].background = newDrawable(getDrawable("touchpad-background"), opoL)
            tpadOneDark[hue].knob = newDrawable(getDrawable("touchpad-knob"), opoL)
        
            add("one${hue}dark", scrollOneDark[hue])
            add("one${hue}dark", splitOneDark[hue])
            add("one${hue}dark", treeOneDark[hue])
            add("one${hue}dark", labelOneDark[hue])
            add("one${hue}dark", buttonOneDark[hue])
            add("one${hue}dark", tbuttonOneDark[hue])
            add("one${hue}dark", checkOneDark[hue])
            add("one${hue}dark", tfieldOneDark[hue])
            add("one${hue}dark", tareaOneDark[hue])
            add("one${hue}dark", listOneDark[hue])
            add("one${hue}dark", selectOneDark[hue])
            add("one${hue}dark", progressOneDark[hue])
            add("one${hue}dark", sliderOneDark[hue])
            add("one${hue}dark", windowOneDark[hue])
            add("one${hue}dark", tpadOneDark[hue])
            add("one${hue}dark", dialogOneDark[hue])
